...
// Purely presentational section header, shared across every Home-page widget
// feature (game-of-day, top-ranking, latest-news, top-courses, top-books,
// completed-games — see each feature's view/ for its consumer) — see
// CLAUDE.md's code-splitting mandate: since none of those features may
// import another's view files, this header lives here instead of being
// owned by (and duplicated across, or orphaned in) any one of them.
