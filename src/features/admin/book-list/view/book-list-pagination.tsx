...
// Duplicated from news-management-pagination.tsx rather than imported — each
// feature's view layer is self-contained per CLAUDE.md's code-splitting
// mandate (features may only be reached through their own route(s)).
function BookListPagination({
  page,
  totalPages,
  hasNext,
  hasPrevious,
  ...
  const t = useTranslations("Admin.bookManagement.pagination")
