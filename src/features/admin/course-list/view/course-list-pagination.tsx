...
// Duplicated from book-list-pagination.tsx rather than imported — each
...
function CourseListPagination({
  ...
  const t = useTranslations("Admin.courseManagement.pagination")
