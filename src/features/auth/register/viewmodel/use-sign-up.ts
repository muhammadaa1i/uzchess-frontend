...
import { useRegisterMutation } from "@/features/auth/register/model/register-api"
import {
  createSignUpFormSchema,
  type SignUpFormValues,
} from "@/features/auth/register/model/register-form-schema"
import { getAuthErrorMessage, isThrottled } from "@/features/auth/session/model/auth-error"
import { authModalOpened, credentialsSet } from "@/features/auth/session/model/auth-slice"
import {
