...
// `unknown` at the catch site). Duplicated from Library/Courses' identical
// helper rather than imported — each feature's model layer is self-contained
