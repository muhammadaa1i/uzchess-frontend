...
// `unknown` at the catch site). Duplicated from Cart/Library/Courses'
// identical helper rather than imported — each feature's model layer is
// self-contained per CLAUDE.md's code-splitting mandate.
...
export { getCheckoutErrorMessage }
