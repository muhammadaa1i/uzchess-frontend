...
// doesn't resolve to an active coupon (see @/features/commerce/cart/model/cart-schemas.ts).
...
// @/features/commerce/cart/model/cart-schemas.ts rather than imported (each feature's
