...
import { LessonErrorState } from "@/features/courses/lessons/view/lesson-error-state"
import { LessonLocked } from "@/features/courses/lessons/view/lesson-locked"
import { LessonNotFound } from "@/features/courses/lessons/view/lesson-not-found"
import { LessonSignInRequired } from "@/features/courses/lessons/view/lesson-sign-in-required"
import { LessonSkeleton } from "@/features/courses/lessons/view/lesson-skeleton"
import { useLesson } from "@/features/courses/lessons/viewmodel/use-lesson"
...
const NextLessonLockedModal = dynamic(
  () =>
    import("@/features/courses/lessons/view/next-lesson-locked-modal").then(
