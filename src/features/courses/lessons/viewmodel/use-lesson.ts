...
} from "@/features/courses/lessons/model/course-progress-api"
import { getLessonErrorMessage } from "@/features/courses/lessons/model/lesson-error"
...
function useLesson(courseId: number, lessonId: number) {
  ...
  async function handleComplete() {
    ...
    try {
      ...
      setErrorMessage(getLessonErrorMessage(error, t("generic")))
    }
  }
