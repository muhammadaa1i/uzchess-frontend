...
// same helper as the Ranking page's pagination
// (src/features/ranking/view/ranking-pagination.tsx), duplicated rather
// than shared per CLAUDE.md's code-splitting mandate.
