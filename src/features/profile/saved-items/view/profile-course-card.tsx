...
import type { ProfileCourseItem } from "@/features/profile/saved-items/model/profile-saved-items-schemas"
...
// Purely presentational grid card for the saved-courses list —
...
// CourseCard, nor from purchased-courses' identical-looking copy, for the
// same reason (each feature's view layer is self-contained).
